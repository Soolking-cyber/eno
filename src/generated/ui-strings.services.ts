...
export const UI_STRINGS_SERVICES: string[] = [
  ...
  "Enter it again to change it. We never show a saved account number.",
  "Estimated day cost",
  "Evening",
  ...
  "Not on the map yet",
  "Not open in your country yet",
  "Not ready yet",
  "Nothing is charged here. The desk confirms the fee and how to pay with you in this chat.",
  "Official e-Visa website",
  "One day of a Ho Chi Minh City itinerary — the same numbered pins appear on the map beside the list.",
  "Only banks that can receive a QR transfer are listed.",
  ...
  "Please do not send a payment for it. Check your messages.",
  ...
  "Saved. You can now be paid by QR.",
  "Scan to pay",
  ...
  "Sign in to set up how you get paid.",
  ...
  "Start a new e-Visa application in this chat",
  ...
  "This trip plan is no longer available.",
  ...
  "Top-up is unavailable right now.",
  "Total",
  "Transfer note",
  ...
  "We need to check your details",
  "We need to check your wallet",
  "We need to confirm where you live",
  "Weather",
  "What do you enjoy?",
  ...
  "Your application was deleted. Start a new one here.",
