...
const EN: Record<string, string> = {
  ...
  'header.toastDesc': 'New listings are reviewed by an eno.vn agent before going live.',
  ...
  'detail.verifiedListingDesc': 'This listing has been physically verified by an eno.vn agent. Photos, location, and price are 100% accurate.',
...
const VI: Record<string, string> = {
  ...
  'header.toastDesc': 'Tin đăng mới được kiểm duyệt thực tế bởi quản trị viên eno.vn trước khi hiển thị.',
  ...
  'detail.verifiedListingDesc': 'Tin đăng này đã được xác thực thực tế bởi kiểm duyệt viên eno.vn. Hình ảnh, vị trí và giá cả chính xác 100%.',
