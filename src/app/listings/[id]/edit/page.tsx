...
export default async function EditListingPage({ params }: Props) {
  ...
  const listing = await db.listing.findUnique({
    where: { id },
    select: { id: true, sellerId: true, title: true, description: true, price: true, district: true, condition: true, brandSlug: true, model: true, subcategorySlug: true, year: true, mileageKm: true, engineL: true, engineCc: true, images: true, currency: true, category: { select: { slug: true } } },
  })
  if (!listing) notFound()
