...
// lands on the CASE LIST — management only (Phase 3): each case opens its own thread,
// and a new one starts with the generic chat CTA. Old bookmarks, notification deep links and
