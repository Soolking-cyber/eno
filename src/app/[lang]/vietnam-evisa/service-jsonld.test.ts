...
describe('e-visa Service JSON-LD', () => {
  ...
  it.each([
    ...
    // ⚠️ THE DECISION IS COUNSEL'S, AND src/app/[lang]/layout.tsx CARRIES THE REASONING. A `sameAs` or a
  ...
  it('is emitted by every services page that offers the service', () => {
    ...
    for (const file of [
      'src/app/[lang]/vietnam-evisa/page.forum.svc.tsx',
      'src/app/[lang]/vietnam-evisa/official-process/page.forum.svc.tsx',
      'src/app/[lang]/services-for-expats-vietnam/page.forum.svc.tsx',
    ]) {
