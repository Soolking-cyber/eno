 ...
 * `src/app/[lang]/[handle]` — the root dynamic segment that doubles as the catch-all for unknown top-level
 ...
 * comment at src/app/[lang]/[handle]/page.tsx:56 explains why that was chosen over a soft-404) and pays
      ...
      <main id="main" tabIndex={-1} className="relative flex flex-1 items-center justify-center overflow-hidden px-3 py-16">
        ...
        <div className="relative w-full max-w-lg text-center">
          ...
          {/*
            ...
            ⚠️ NO SERVICES VOCABULARY AS A `<Tr>` LITERAL EITHER — src/app/[lang]/not-found.tsx is not on
