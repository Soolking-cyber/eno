...
function AdminDenied() { return <main className="mx-auto max-w-lg px-6 py-24 text-center"><LockIcon /><h1 className="mt-4 text-2xl font-bold">Admin access required</h1><p className="mt-2 text-sm text-body">Sign in with an email listed in VISA_ADMIN_EMAILS.</p><Link href="/" className="mt-5 inline-flex h-11 items-center rounded-xl border border-line-strong px-4 text-sm font-bold">Back to forum</Link></main> }
