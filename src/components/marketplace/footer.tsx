      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1 space-y-3">
            <img src="/logo.svg" alt="ENO" className="h-9 w-auto" />
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-2 border-t border-slate-200/60 pt-5 text-xs text-[#94a3b8] dark:border-slate-800/40 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1">
            <a href="#top" className="transition-colors hover:text-[#0a66c2]">{tr('Terms', 'Điều khoản')}</a>
            <a href="#top" className="transition-colors hover:text-[#0a66c2]">{tr('Privacy', 'Quyền riêng tư')}</a>
            <a href="#top" className="transition-colors hover:text-[#0a66c2]">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
