  ...
  return (
    <div>
      ...
      <div className="mt-4 flex items-center gap-3">
        {/* ⛔ SAVING DURING AN UPLOAD DISCARDS IT. `save()` reads whatever `bannerUrl`/`avatarUrl`
            hold at click time, so a shop that starts an upload and immediately saves another dirty
            field PATCHes the OLD url and the finished upload is then overwritten by the resynced
