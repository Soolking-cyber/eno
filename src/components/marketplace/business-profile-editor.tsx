...
export function BusinessProfileEditor({ seller, onSaved }: { seller: Seller; onSaved: () => void }) {
  ...
  const field = 'w-full rounded-xl border border-line-strong bg-card px-3.5 py-2.5 text-sm text-foreground outline-none transition-colors focus:border-ring focus:ring-2 focus:ring-ring/30'
  ...
  return (
    <div className="rounded-2xl bg-card p-4 shadow-pop">
      <div className="flex items-center gap-4">
        ...
        <label className="inline-flex cursor-pointer items-center gap-1.5 rounded-xl border border-line-strong bg-card px-3 py-1.5 text-xs font-semibold text-body transition-colors hover:bg-muted">
