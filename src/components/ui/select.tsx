...
function SelectContent({
  ...
  return (
    <SelectPrimitive.Portal>
      ...
      <SelectPrimitive.Backdrop className="overlay-scrim pointer-events-none fixed inset-0 z-40" />
