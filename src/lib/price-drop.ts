...
//
// A qualifying drop earns (a) the badge for 7 days and (b) at most ONE buyer
...
export const DROP = {
  ...
  BADGE_MS: 7 * DAY,          // drop badge lifetime
...
export async function priceChangeEffects(
  ...
  // window keep the ORIGINAL anchor (cumulative % shown) and reset the 7-day clock.
  const badgeActive =
