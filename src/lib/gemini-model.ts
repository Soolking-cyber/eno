 ...
 * 3.5 → 3.6 → 3.7 twice this year, and a script pinned to the old line would keep working while
...
// review) and as the safe manual downgrade if 3.7 has an incident.
// ⚠️ DELIBERATELY NOT ALSO 3.7 — a fallback identical to the primary is not a fallback. It stays on
// the older, region-robust line precisely so it survives an incident that takes 3.7 out.
