---
name: impeccable
description: Design, redesign, critique, audit, polish, harden or animate a frontend interface — websites, landing pages, dashboards, product UI, components, forms, onboarding, empty states. Covers UX review, visual hierarchy, accessibility, responsive behaviour, theming, typography, layout, color, motion, UX copy, and design systems or tokens; also making a bland design bolder or a loud one quieter. Not for backend-only or non-UI tasks.
version: 4.0.4
user-invocable: true
