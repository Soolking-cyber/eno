...
| Commit-gate third seat | `scripts/second-opinion.mjs` | **Fable 5 · max** (restored 2026-08-23 after one day on Opus). ⚠️ Same lab as the main thread, different model — a 3/3 is two families agreeing, not three. Past 180KB agy stops counting, so the quorum becomes codex + fable. |
